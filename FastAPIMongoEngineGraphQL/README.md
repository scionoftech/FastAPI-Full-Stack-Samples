# FastAPI-MongoEngine-GraphQL

FastAPI-MongoEngine is a Python API Application with FastAPI,GraphQL, JWT Authentication,
...
- graphene-mongo - [Graphene MongoEngine integration](https://github.com/graphql-python/graphene-mongo)
